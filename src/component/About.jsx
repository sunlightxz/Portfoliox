  ...
  return (
    <section id='about' className='pt-10 pb-24'>
      <div className="">
        ...
        >
          <p className='font-poppins font-semibold text-4xl mb-5 dark:text-black'>
        ...
        */}
        ...
        <div className="flex justify-between mt-5 md:flex-row flex-col ">
          ...
          >
          <div class="left-about py-4 dark:text-black">
          <div class="info-item py-3 md:border-b-[#39557a] md:border-b-2 ">
            ...
            <div class="info-item py-3 mb-9 md:border-b-[#39557a] md:border-b-2">
              ...
              <a href ={cv} download ="Cv"  className='bg-gradient-rainblue cursor-pointer text-slate-900 rounded-sm py-3 px-7 font-semibold 
              hover:bg-orange-600 hover:text-white transition duration-500 dark:text-white dark:hover:text-black'
           ...
           <div class="right-about py-4 md:mt-0 mt-5 ">
           <div class="about-item">
             <div class="abt-text ">
               <p class="lrg-text ">9+</p>
               <p class="small-text text-[#dbe1e8] dark:text-black ">PROJECTS <br />COMPLETED</p>
              </div>
           </div>
           <div class="about-item">
             <div class="abt-text">
               <p class="lrg-text">3+</p>
               <p class="small-text text-[#dbe1e8] dark:text-black ">YEARS <br />EXPERIENCE</p>
              </div>
           </div>
           <div class="about-item">
             <div class="abt-text">
